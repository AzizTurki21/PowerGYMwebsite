...
if (isset($_SESSION['registration_message'])) {
    ...
    echo '</script>';
    unset($_SESSION['registration_message']); // Clear the registration message after displaying it
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST["email"]) && !empty($_POST["password"])) {
    ...
    $stmt = $conn->prepare("SELECT name FROM client_info WHERE email=? AND password=?");
...
<!-- The rest of your HTML and code remains unchanged -->
